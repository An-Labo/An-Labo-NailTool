...
namespace world.anlabo.mdnailtool.Editor.VisualElements {
	internal class LocalizedButton : Button, ILocalizedElement {
		...
		internal new class UxmlFactory : UxmlFactory<LocalizedButton, UxmlTraits> { }
		...
		internal new class UxmlTraits : Label.UxmlTraits {
			...
			public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc) {
				base.Init(ve, bag, cc);
				if (ve is not LocalizedButton localizedElement) return;
